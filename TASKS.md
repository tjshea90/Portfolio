...
**There is no active job right now.** v7.10 (versionCode 67) is shipped — the
BUY/HOLD/SELL badge now appears both on the detail screen (v7.9) and next to
each holding on the main Portfolio tab. See `BUILDLOG.md` for the full
release history.
