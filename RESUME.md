# RESUME — READ THIS FIRST  (round 61, saved 2026-09-08 02:25:51 UTC)
...
**Resume at T2** (Model + persistence: a PlMode setting that survives a restart, in the backup, no DB migration).
