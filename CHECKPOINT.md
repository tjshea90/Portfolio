# CHECKPOINT 1681 — read me first, then TASKS.md

**Written:** 2026-09-24T16:20:51Z · **tests:** all 2 fast checks green (gradle suite: see ship.sh)
**Branch:** `claude/full-tests-completion-tw9a1o` · **builds on:** `1d733796` (this checkpoint is the commit after it)

## Just done
S-3, S-9..S-12 fixed (+5 tests)

## Do this next
U-4..8, then Qs, suite, review, ship
...
```
  c686b33c ckpt 1680: A-5..A-11 fixed (+5 tests)
