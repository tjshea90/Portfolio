# CHECKPOINT 1731 — read me first, then TASKS.md

**Written:** 2026-09-25T02:15:05Z · **tests:** all 2 fast checks green (gradle suite: see ship.sh)
**Branch:** `claude/resume-in-progress-8vmll2` · **builds on:** `240abc5b` (this checkpoint is the commit after it)

## Just done
Round 3 done inline: R3G-1 (422 from both hosts), R3G-2 (straddle gap ambiguous), R3T-1 (wording) fixed + tested; Grader 33/0, Tuning 29/0

## Do this next
Full unit suite, then ship v8.0 (bump versionCode/Name, ship.sh, trigger android.yml full_build, record-release, post link)
...
## Uncommitted right now
     M CHECKPOINT.md
     M TASKS.md
     M audits/2026-09-24c/round3-grading.md
     M audits/2026-09-24c/round3-tuning.md
