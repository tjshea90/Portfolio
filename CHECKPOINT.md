# CHECKPOINT 1544 — read me first, then TASKS.md

**Written:** 2026-09-18T17:08:00Z · **tests:** all 3 fast checks green (gradle suite: see ship.sh)
**Branch:** `claude/analyst-ratings-staleness-review-gt1upk` · **builds on:** `16787d2` (this checkpoint is the commit after it)

## Just done
Audited the recommendation + day-trading code; wrote Tj's 2026-09-18 request into TASKS.md

## Do this next
Implement net/RatingRecency.kt and wire it into ResearchScore.holding
